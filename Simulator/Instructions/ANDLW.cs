...
namespace Friendly.Electronics.Simulator.Instructions
{
    ...
    // Operation:     (W) AND (k) -> (W)
    // Status bits:   Z
    // Description:   The contents of the W register are AND’ed with the 8-bit literal ‘k’.
    //                The result is placed in the W register. 
    
    public class ANDLW : Instruction
    {
        private readonly Register _w;
        private readonly Register _status;
        private int _k;
        
        public ANDLW(Microcontroller microcontroller) : base("ANDLW")
        {
