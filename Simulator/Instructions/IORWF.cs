...
namespace Friendly.Electronics.Simulator.Instructions
{
    ...
    // Status bits:   Z
    // Description:   Inclusive OR the W register with register ‘f’. If ‘d’ is ‘0’, the result
    //                is placed in the W register. If ‘d’ is ‘1’, the result is placed back in
    //                register ‘f’.
    
    public class IORWF : Instruction
    {
        ...
        public IORWF(Microcontroller microcontroller) : base("IORWF")
        {
