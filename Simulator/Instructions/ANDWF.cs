...
namespace Friendly.Electronics.Simulator.Instructions
{
    ...
    // Status bits:   Z
    // Description:   The contents of the W register are AND’ed with register ‘f’. If ‘d’ is ‘0’,
    //                the result is stored in the W register. If ‘d’ is ‘1’, the result is stored
    //                back in register ‘f’.
    
    public class ANDWF : Instruction
    {
        ...
        public ANDWF(Microcontroller microcontroller) : base("ANDWF")
        {
