...
namespace Friendly.Electronics.Simulator.Instructions
{
    ...
    public class InstructionDecoder
    {
        ...
        public InstructionDecoder(Microcontroller microcontroller)
        {
            ...
            _instructions = new []
            {
                /* 00 00 00 */ allInstructions["NOP"],
                /* 00 00 01 */ allInstructions["NOP"],
                /* 00 00 10 */ allInstructions["SUBWF"],
                /* 00 00 11 */ allInstructions["DECF"],
                ...
                /* 01 10 00 */ allInstructions["BTFSC"],
                /* 01 10 00 */ allInstructions["BTFSC"],
                /* 01 10 00 */ allInstructions["BTFSC"],
                /* 01 10 00 */ allInstructions["BTFSC"],
                /* 01 11 00 */ allInstructions["BTFSS"],
                /* 01 11 00 */ allInstructions["BTFSS"],
                /* 01 11 00 */ allInstructions["BTFSS"],
                /* 01 11 00 */ allInstructions["BTFSS"],
                /* 10 00 00 */ allInstructions["RETLW"],
                /* 10 00 00 */ allInstructions["RETLW"],
                /* 10 00 00 */ allInstructions["RETLW"],
                /* 10 00 00 */ allInstructions["RETLW"],
                /* 10 01 00 */ allInstructions["CALL"],
                /* 10 01 00 */ allInstructions["CALL"],
                /* 10 01 00 */ allInstructions["CALL"],
                /* 10 01 00 */ allInstructions["CALL"],
                /* 10 10 00 */ allInstructions["GOTO"],
                /* 10 10 01 */ allInstructions["GOTO"],
                /* 10 10 10 */ allInstructions["GOTO"],
                /* 10 10 11 */ allInstructions["GOTO"],
                /* 10 11 00 */ allInstructions["GOTO"],
                /* 10 11 01 */ allInstructions["GOTO"],
                /* 10 11 10 */ allInstructions["GOTO"],
                /* 10 11 11 */ allInstructions["GOTO"],
                /* 11 00 00 */ allInstructions["MOVLW"],
                /* 11 00 01 */ allInstructions["MOVLW"],
                /* 11 00 10 */ allInstructions["MOVLW"],
                /* 11 00 11 */ allInstructions["MOVLW"],
