...
namespace Friendly.Electronics.Simulator.Instructions
{
    ...
    //                in register ‘f’. If the result is ‘0’, then the next instruction, which
    //                is already fetched, is discarded and a NOP is executed instead making it
    //                a 2-cycle instruction.
    
    public class INCFSZ : Instruction
    {
        ...
        public INCFSZ(Microcontroller microcontroller) : base("INCFSZ")
        {
