...
namespace Friendly.Electronics.Simulator.Tests.Instructions
{
    ...
    {
        [DataTestMethod]
        [DataRow(0b_1111_0000, 0b_1010_1010, 0b_1010_0000, false)]
        [DataRow(0b_1111_0000, 0b_1010_1010, 0b_1010_0000, false)]
        [DataRow(0b_1010_0101, 0b_0101_1010, 0b_0000_0000, true)]
        public void ANDLW(int value, int k, int result, bool z)
        {
            Clock.Reset();
            var micro = new PIC10F200();
            var debugger = new MicrocontrollerDebugger(micro);
            
            debugger.ProgramMemory[0].Value = 0b_111000_000000 | k;    // 1110 kkkk kkkk
            ...
            Assert.AreEqual(result, debugger.AllRegisters["W"].Value, "ANDLW should calculate W AND k correctly.");
